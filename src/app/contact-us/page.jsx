                            ...
                            <div className="grid gap-5">
                                <div className='grid md:grid-cols-2 grid-cols-1 gap-4'>
                                    <div className="w-full">
                                        ...
                                        <input className={`px-5 py-4 rounded-[30px] text-sm font-normal placeholder:text-darkBlue text-darkBlue focus:outline-none w-full border border-[#DFE3ED] ${errors.name && 'border-red-400'}`} placeholder="Your Name*" type="text" id="name" {...register("name", { required: true })} />
                                    </div>
                                    <div className="w-full">
                                        <label htmlFor="email" className="hidden mb-2">Email</label>
                                        <input className={`px-5 py-4 rounded-[30px] text-sm font-normal placeholder:text-darkBlue text-darkBlue focus:outline-none w-full border border-[#DFE3ED] ${errors.email && 'border-red-400'}`} placeholder="Your Email*" type="email" id="email" {...register("email", { required: true })} />
                                    </div>
                                </div>
                                <div className='grid md:grid-cols-2 grid-cols-1 gap-4'>
                                    <div className="w-full">
                                        <label htmlFor="phone" className="hidden mb-2">Phone</label>
                                        <input className={`px-5 py-4 rounded-[30px] text-sm font-normal placeholder:text-darkBlue text-darkBlue focus:outline-none w-full border border-[#DFE3ED] ${errors.phone && 'border-red-400'}`} placeholder="Phone Number*" type="tel" id="phone"  {...register("phone", { required: true })} />
                                    </div>
                                    <div className="w-full">
                                        <label htmlFor="company" className="hidden mb-2">Company Name</label>
                                        <input className={`px-5 py-4 rounded-[30px] text-sm font-normal placeholder:text-darkBlue text-darkBlue focus:outline-none w-full border border-[#DFE3ED] ${errors.company && 'border-red-400'}`} placeholder="Company Name*" type="text" id="company"  {...register("company", { required: true })} />
                                    </div>
                                </div>
                                <div className="w-full">
                                    <label htmlFor="subject" className="hidden mb-2">Subject</label>
                                    <input className={`px-5 py-4 rounded-[30px] text-sm font-normal placeholder:text-darkBlue text-darkBlue focus:outline-none w-full border border-[#DFE3ED] ${errors.subject && 'border-red-400'}`} placeholder="Subject" type="text" id="subject" {...register("subject", { required: true })} />
                                </div>
                                <div className="w-full">
                                    <textarea id="message" className={`px-5 py-4 rounded-[19px] text-sm font-normal placeholder:text-darkBlue text-darkBlue focus:outline-none w-full border border-[#DFE3ED] h-[126px] ${errors.message && 'border-red-400'}`} rows={3} placeholder="Message" {...register("message", { required: true })}></textarea>
                                </div>
